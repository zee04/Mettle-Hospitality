...
class FlippingCoverFlow {
    constructor(containerSelector) {
        ...
        this.projects = [
            ...
            { title: 'Doppler', type: '', description: "Conceptualized a café for Boomerang Hospitality in a historic Jaipur haveli, redefining the experience as the city's premier slow bar destination.", logo: 'images/project-images/doppler.jpg' },
